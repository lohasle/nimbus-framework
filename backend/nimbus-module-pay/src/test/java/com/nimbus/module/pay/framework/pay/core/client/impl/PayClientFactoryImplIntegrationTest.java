package com.nimbus.module.pay.framework.pay.core.client.impl;
...
import com.nimbus.module.pay.framework.pay.core.client.impl.PayClientFactoryImpl;
import com.nimbus.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import com.nimbus.module.pay.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import com.nimbus.module.pay.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import com.nimbus.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import com.nimbus.module.pay.framework.pay.core.client.impl.weixin.WxPubPayClient;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_WX_PUB_V3() throws FileNotFoundException {
        ...
        config.setPrivateKeyContent(IoUtil.readUtf8(new FileInputStream("/Users/nimbus/Downloads/wx_pay/apiclient_key.pem")));
//        config.setPrivateCertContent(IoUtil.readUtf8(new FileInputStream("/Users/nimbus/Downloads/wx_pay/apiclient_cert.pem")));
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("http://nimbus.natapp1.cc/admin-api/pay/notify/callback/18"); // TODO @tina: 这里改成你的 natapp 回调地址
