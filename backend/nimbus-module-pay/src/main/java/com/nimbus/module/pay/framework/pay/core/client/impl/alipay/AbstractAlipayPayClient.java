package com.nimbus.module.pay.framework.pay.core.client.impl.alipay;
...
import static com.nimbus.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_CERTIFICATE;
import static com.nimbus.module.pay.framework.pay.core.client.impl.alipay.AlipayPayClientConfig.MODE_PUBLIC_KEY;
...
public abstract class AbstractAlipayPayClient extends AbstractPayClient<AlipayPayClientConfig> {
    ...
    // TODO @Nimbus：由于支付宝一直没触发回调，这个方法暂时没办法测试
    @Override
