package com.nimbus.module.pay.service.wallet;
...
import com.nimbus.module.pay.api.refund.PayRefundApi;
...
import com.nimbus.module.pay.controller.app.wallet.vo.recharge.AppPayWalletRechargeCreateReqVO;
...
import com.nimbus.module.pay.dal.dataobject.wallet.PayWalletRechargeDO;
import com.nimbus.module.pay.dal.dataobject.wallet.PayWalletRechargePackageDO;
import com.nimbus.module.pay.dal.mysql.wallet.PayWalletRechargeMapper;
import com.nimbus.module.pay.enums.PayChannelEnum;
import com.nimbus.module.pay.enums.order.PayOrderStatusEnum;
import com.nimbus.module.pay.enums.refund.PayRefundStatusEnum;
import com.nimbus.module.pay.enums.wallet.PayWalletBizTypeEnum;
import com.nimbus.module.pay.framework.pay.config.PayProperties;
import com.nimbus.module.pay.service.order.PayOrderService;
import com.nimbus.module.system.api.social.SocialClientApi;
import com.nimbus.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.nimbus.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
...
import static com.nimbus.framework.common.util.date.LocalDateTimeUtils.addTime;
import static com.nimbus.framework.common.util.json.JsonUtils.toJsonString;
import static com.nimbus.framework.common.util.number.MoneyUtils.fenToYuanStr;
import static com.nimbus.module.pay.convert.wallet.PayWalletRechargeConvert.INSTANCE;
import static com.nimbus.module.pay.enums.ErrorCodeConstants.*;
import static com.nimbus.module.pay.enums.MessageTemplateConstants.WXA_WALLET_RECHARGER_PAID;
import static com.nimbus.module.pay.enums.refund.PayRefundStatusEnum.*;
...
public class PayWalletRechargeServiceImpl implements PayWalletRechargeService {
    ...
    public PayWalletRechargeDO createWalletRecharge(Long userId, Integer userType, String userIp,
        ...
        Long payOrderId = payOrderService.createOrder(new PayOrderCreateReqDTO()
                ...
                .setExpireTime(addTime(Duration.ofHours(2L)))); // TODO @Nimbus：支付超时时间
        // 2.2 更新钱包充值记录中支付订单
    ...
    private PayWalletDO validateWalletRechargeCanRefund(PayWalletRechargeDO walletRecharge) {
        ...
        // TODO @Nimbus：需要考虑下，赠送的金额，会不会导致提现超过；
        return wallet;
    }
