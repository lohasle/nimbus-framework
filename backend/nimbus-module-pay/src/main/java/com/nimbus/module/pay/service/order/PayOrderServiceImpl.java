...
import com.nimbus.framework.common.util.number.MoneyUtils;
...
import com.nimbus.module.pay.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
...
import com.nimbus.module.pay.convert.order.PayOrderConvert;
    ...
    public PayOrderSubmitRespVO submitOrder(PayOrderSubmitReqVO reqVO, String userIp) {
        ...
        if (unifiedOrderResp != null) {
            try {
                ...
                // 兼容 https://gitee.com/zhijiantianya/nimbus-cloud/issues/I8SM9H 场景
