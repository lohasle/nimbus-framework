package com.nimbus.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, com.nimbus.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
