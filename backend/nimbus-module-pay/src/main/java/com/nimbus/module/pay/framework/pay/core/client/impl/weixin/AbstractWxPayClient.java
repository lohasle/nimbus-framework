package com.nimbus.module.pay.framework.pay.core.client.impl.weixin;
...
import com.nimbus.framework.common.util.io.FileUtils;
...
import static com.nimbus.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.nimbus.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/nimbuscode/nimbus-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // TODO @Nimbus：【可能是 wxjava 的 bug】参考 https://github.com/binarywang/WxJava/issues/1557
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/nimbus-cloud/issues/ICSFL6
