package com.nimbus.module.pay.controller.admin.transfer.vo;

import com.nimbus.framework.excel.core.annotations.DictFormat;
import com.nimbus.framework.excel.core.convert.DictConvert;
import com.nimbus.framework.excel.core.convert.MoneyConvert;
import com.nimbus.module.pay.enums.DictTypeConstants;
...
public class PayTransferRespVO {
    ...
    @ExcelProperty("应用名称")
    @Schema(description = "应用名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nimbus")
    ...
    @Schema(description = "异步通知商户地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nimbus.local")
