package com.nimbus.module.member.service.auth;

import cn.hutool.core.lang.Assert;
import com.nimbus.framework.common.enums.CommonStatusEnum;
import com.nimbus.framework.common.enums.TerminalEnum;
...
import com.nimbus.module.member.convert.auth.AuthConvert;
import com.nimbus.module.member.dal.dataobject.user.MemberUserDO;
import com.nimbus.module.member.service.user.MemberUserService;
import com.nimbus.module.system.api.logger.LoginLogApi;
import com.nimbus.module.system.api.logger.dto.LoginLogCreateReqDTO;
import com.nimbus.framework.common.biz.system.oauth2.OAuth2TokenCommonApi;
import com.nimbus.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
import com.nimbus.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenRespDTO;
import com.nimbus.module.system.api.sms.SmsCodeApi;
import com.nimbus.module.system.api.social.SocialClientApi;
import com.nimbus.module.system.api.social.SocialUserApi;
import com.nimbus.module.system.api.social.dto.SocialUserBindReqDTO;
import com.nimbus.module.system.api.social.dto.SocialUserRespDTO;
import com.nimbus.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
import com.nimbus.module.system.enums.logger.LoginLogTypeEnum;
import com.nimbus.module.system.enums.logger.LoginResultEnum;
import com.nimbus.module.system.enums.oauth2.OAuth2ClientConstants;
...
import static com.nimbus.framework.common.util.servlet.ServletUtils.getClientIP;
import static com.nimbus.framework.web.core.util.WebFrameworkUtils.getTerminal;
import static com.nimbus.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO Nimbus：后续 member user 手机非强绑定，这块需要做下调整；
