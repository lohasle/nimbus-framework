package com.nimbus.module.member.controller.admin.user.vo;
...
import static com.nimbus.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY;
...
public class MemberUserBaseVO {
    ...
    @Schema(description = "头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nimbus.local/x.png")
