package com.nimbus.module.member.controller.app.user.vo;
...
public class AppMemberUserInfoRespVO {
    ...
    @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nimbus.local/xxx.png")
    private String avatar;

    @Schema(description = "用户手机号", requiredMode = Schema.RequiredMode.REQUIRED, example = "15601691300")
    private String mobile;

    @Schema(description = "邮箱", example = "member@nimbus.local")
    ...
    public static class Level {
        ...
        @Schema(description = "等级名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nimbus")
        private String name;

        @Schema(description = "等级", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
        private Integer level;

        @Schema(description = "等级图标", example = "https://www.nimbus.local/nimbus.jpg")
        private String icon;
