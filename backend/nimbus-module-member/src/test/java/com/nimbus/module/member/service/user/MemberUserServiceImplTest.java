...
import com.nimbus.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.nimbus.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, NimbusRedisAutoConfiguration.class})
...
//    }
    ...
    public void updateMobile_success(){
        ...
        // TODO Nimbus：需要修复该单元测试，重构多模块带来的
        // 旧手机和旧验证码
