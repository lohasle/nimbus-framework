package com.nimbus.framework.common.util.json.databind;
...
public class TimestampLocalDateTimeSerializer extends StdScalarSerializer<LocalDateTime> {
    ...
    public void serialize(LocalDateTime value, JsonGenerator gen, SerializationContext serializers) throws JacksonException {
        // 情况一：有 JsonFormat 自定义注解，则使用它。https://github.com/nimbusV/nimbus-platform/pull/1019
        ...
        if (fieldName != null) {
            ...
            if (currentValue != null) {
                ...
                // 进一步修复：https://gitee.com/zhijiantianya/nimbus-platform/pulls/1480
