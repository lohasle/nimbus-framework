package com.nimbus.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.nimbus.framework.common.util.json.JsonUtils;
import com.nimbus.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${nimbus.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class NimbusMybatisAutoConfiguration {
