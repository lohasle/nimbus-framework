package com.nimbus.framework.mybatis.core.util;
...
import com.nimbus.framework.common.pojo.SortingField;
import com.nimbus.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/nimbus-cloud/issues/ID2QLL
        // 排序字段
     ...
     *
     * 使用场景：
     * 1. <a href="https://gitee.com/zhijiantianya/nimbus-platform/pulls/1357/files">fix:修复"商品统计聚合函数的别名与排序字段不符"导致的 SQL 异常</a>
     *
