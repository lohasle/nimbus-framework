package com.nimbus.framework.operatelog.core.service;

import com.nimbus.framework.common.biz.system.logger.OperateLogCommonApi;
...
public class LogRecordServiceImpl implements ILogRecordService {
    ...
    public static void fillModuleFields(OperateLogCreateReqDTO reqDTO, LogRecord logRecord) {
        ...
        reqDTO.setAction(logRecord.getAction());// 操作内容，例如：修改编号为 1 的用户信息，将性别从男改成女，将姓名从Nimbus改成源码。
