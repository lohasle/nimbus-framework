package com.nimbus.framework.quartz.core.scheduler;

import com.nimbus.framework.quartz.core.enums.JobDataKeyEnum;
import com.nimbus.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;

import static com.nimbus.framework.common.exception.enums.GlobalErrorCodeConstants.NOT_IMPLEMENTED;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 https://doc.nimbus.local/job/ 开启]");
        }
    }
