package com.nimbus.framework.tenant.config;

import com.nimbus.framework.common.biz.system.tenant.TenantCommonApi;
import com.nimbus.framework.common.enums.WebFilterOrderEnum;
import com.nimbus.framework.mybatis.core.util.MyBatisUtils;
import com.nimbus.framework.redis.config.NimbusCacheProperties;
import com.nimbus.framework.security.core.service.SecurityFrameworkService;
import com.nimbus.framework.tenant.core.aop.TenantIgnore;
import com.nimbus.framework.tenant.core.aop.TenantIgnoreAspect;
import com.nimbus.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.nimbus.framework.tenant.core.job.TenantJobAspect;
import com.nimbus.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.nimbus.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.nimbus.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.nimbus.framework.tenant.core.redis.TenantRedisCacheManager;
import com.nimbus.framework.tenant.core.security.TenantSecurityWebFilter;
import com.nimbus.framework.tenant.core.service.TenantFrameworkService;
import com.nimbus.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.nimbus.framework.tenant.core.web.TenantContextWebFilter;
import com.nimbus.framework.tenant.core.web.TenantVisitContextInterceptor;
...
import static com.nimbus.framework.common.util.collection.CollectionUtils.convertList;

@AutoConfiguration
@ConditionalOnProperty(prefix = "nimbus.tenant", value = "enable", matchIfMissing = true) // 允许使用 nimbus.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class NimbusTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.nimbus.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     NimbusCacheProperties nimbusCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(nimbusCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.nimbus.framework.quartz.core.handler.JobHandler")
