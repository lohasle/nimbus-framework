 ...
 *      1）Spring Async：
 *          {@link com.nimbus.framework.quartz.config.NimbusAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 NimbusSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.nimbus.framework.tenant;
