package com.nimbus.framework.desensitize.core;

import com.nimbus.framework.common.util.json.JsonUtils;
import com.nimbus.framework.desensitize.core.annotation.Address;
import com.nimbus.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.nimbus.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.nimbus.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("Nimbus");
        ...
        desensitizeDemo.setRegex("你好，我是Nimbus");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("Nimbus");
        ...
        assertEquals("Nimbus", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "Nimbus", replacer = "*")
