package com.nimbus.framework.web.config;
...
import com.nimbus.framework.web.core.filter.CacheRequestBodyFilter;
import com.nimbus.framework.web.core.filter.DemoFilter;
import com.nimbus.framework.web.core.handler.GlobalExceptionHandler;
import com.nimbus.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class NimbusWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "nimbus.demo", havingValue = "true")
