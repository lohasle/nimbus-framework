package com.nimbus.framework.swagger.config;
...
import static com.nimbus.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
 ...
 */
@AutoConfiguration(before = Knife4jAutoConfiguration.class) // before 原因，保证覆写的 Knife4jOpenApiCustomizer 先生效！相关 https://github.com/nimbusV/nimbus-platform/issues/954 讨论
@ConditionalOnClass({OpenAPI.class})
@EnableConfigurationProperties(SwaggerProperties.class)
@ConditionalOnProperty(prefix = "springdoc.api-docs", name = "enabled", havingValue = "true", matchIfMissing = true) // 设置为 false 时，禁用
@Import(Knife4jOpenApiCustomizer.class)
public class NimbusSwaggerAutoConfiguration {
     ...
     *
     * @see <a href="https://github.com/nimbusV/nimbus-platform/issues/957">app-api 前缀不生效，都是使用 admin-api</a>
     */
