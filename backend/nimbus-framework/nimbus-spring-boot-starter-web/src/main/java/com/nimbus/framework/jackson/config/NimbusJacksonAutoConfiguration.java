package com.nimbus.framework.jackson.config;

import com.nimbus.framework.common.util.json.JsonUtils;
import com.nimbus.framework.common.util.json.databind.NumberSerializer;
import com.nimbus.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.nimbus.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class NimbusJacksonAutoConfiguration {
