package com.nimbus.module.system.controller.admin.oauth2;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.nimbus.framework.common.core.KeyValue;
import com.nimbus.framework.common.enums.UserTypeEnum;
import com.nimbus.framework.common.exception.ErrorCode;
...
import com.nimbus.framework.test.core.ut.BaseMockitoUnitTest;
import com.nimbus.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.nimbus.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.nimbus.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.nimbus.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.nimbus.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.nimbus.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.nimbus.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.nimbus.module.system.service.oauth2.OAuth2ApproveService;
import com.nimbus.module.system.service.oauth2.OAuth2ClientService;
import com.nimbus.module.system.service.oauth2.OAuth2GrantService;
...
import static com.nimbus.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        String clientId = randomString();
        String scope = "{\"read\": true, \"write\": false}";
        String redirectUri = "https://www.nimbus.local";
        String state = "test";
        // mock 方法
        OAuth2ClientDO client = randomPojo(OAuth2ClientDO.class);
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.nimbus.local#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.nimbus.local#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.nimbus.local#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.nimbus.local?code=test_code&state=test", result.getData());
    }
