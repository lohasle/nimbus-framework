package com.nimbus.module.system.service.mail;
...
import com.nimbus.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.nimbus.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.nimbus.module.system.dal.dataobject.mail.MailTemplateDO;
import com.nimbus.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.nimbus.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("Nimbus")));
        // 测试 code 不匹配
