package com.nimbus.module.system.service.oauth2;
...
import com.nimbus.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenPageReqVO;
...
import com.nimbus.module.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import com.nimbus.module.system.dal.dataobject.user.AdminUserDO;
import com.nimbus.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import com.nimbus.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import com.nimbus.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImplTest extends BaseDbAndRedisUnitTest {
    ...
    public void testCreateAccessToken() {
        ...
        // TODO @Nimbus：expiresTime 被屏蔽，仅 win11 会复现，建议后续修复。
    ...
    public void testGetAccessTokenPage() {
        ...
        // 测试 expireTime 不匹配
        oauth2AccessTokenMapper.insert(cloneIgnoreId(dbAccessToken,
                o -> o.setExpiresTime(LocalDateTimeUtil.now().minusMinutes(1))));
        // 准备参数
