package com.nimbus.module.system.service.notify;
...
import com.nimbus.module.system.controller.admin.notify.vo.template.NotifyTemplatePageReqVO;
import com.nimbus.module.system.controller.admin.notify.vo.template.NotifyTemplateSaveReqVO;
import com.nimbus.module.system.dal.dataobject.notify.NotifyTemplateDO;
import com.nimbus.module.system.dal.mysql.notify.NotifyTemplateMapper;
...
import static com.nimbus.module.system.enums.ErrorCodeConstants.NOTIFY_TEMPLATE_NOT_EXISTS;
...
public class NotifyTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetNotifyTemplatePage() {
        ...
        // 测试 name 不匹配
        notifyTemplateMapper.insert(cloneIgnoreId(dbNotifyTemplate, o -> o.setName("Other")));
        // 测试 code 不匹配
