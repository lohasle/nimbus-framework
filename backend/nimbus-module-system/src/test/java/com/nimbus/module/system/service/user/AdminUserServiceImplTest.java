package com.nimbus.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.nimbus.framework.common.enums.CommonStatusEnum;
import com.nimbus.framework.common.exception.ServiceException;
import com.nimbus.framework.common.pojo.PageResult;
import com.nimbus.framework.common.util.collection.ArrayUtils;
import com.nimbus.framework.common.util.collection.CollectionUtils;
import com.nimbus.framework.test.core.ut.BaseDbUnitTest;
import com.nimbus.module.infra.api.config.ConfigApi;
import com.nimbus.module.infra.api.file.FileApi;
import com.nimbus.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.nimbus.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.nimbus.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.nimbus.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.nimbus.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.nimbus.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.nimbus.module.system.dal.dataobject.dept.DeptDO;
import com.nimbus.module.system.dal.dataobject.dept.PostDO;
import com.nimbus.module.system.dal.dataobject.dept.UserPostDO;
import com.nimbus.module.system.dal.dataobject.tenant.TenantDO;
import com.nimbus.module.system.dal.dataobject.user.AdminUserDO;
import com.nimbus.module.system.dal.mysql.dept.UserPostMapper;
import com.nimbus.module.system.dal.mysql.user.AdminUserMapper;
import com.nimbus.module.system.enums.common.SexEnum;
import com.nimbus.module.system.mq.producer.user.AdminUserProducer;
import com.nimbus.module.system.service.dept.DeptService;
import com.nimbus.module.system.service.dept.PostService;
import com.nimbus.module.system.service.oauth2.OAuth2TokenService;
import com.nimbus.module.system.service.permission.PermissionService;
import com.nimbus.module.system.service.tenant.TenantService;
...
import static com.nimbus.framework.common.util.collection.SetUtils.asSet;
import static com.nimbus.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.nimbus.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static com.nimbus.module.system.enums.ErrorCodeConstants.*;
import static com.nimbus.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("nimbussample");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("nimbussample");
        ...
        assertEquals("nimbussample", user.getPassword());
    ...
    public void testUpdateUserPassword_success() {
        ...
        // 断言
        AdminUserDO user = userMapper.selectById(userId);
        assertEquals("encode:sample", user.getPassword());
    }
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("nimbussample"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("Nimbus"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
        userMapper.insert(randomAdminUserDO(o -> o.setNickname("Other")));
        // 准备参数
        String nickname = "Nim";
