...
import com.nimbus.module.system.controller.admin.socail.vo.user.SocialUserPageReqVO;
import com.nimbus.module.system.dal.dataobject.social.SocialUserBindDO;
import com.nimbus.module.system.dal.dataobject.social.SocialUserDO;
import com.nimbus.module.system.dal.mysql.social.SocialUserBindMapper;
import com.nimbus.module.system.dal.mysql.social.SocialUserMapper;
...
import static com.nimbus.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testAuthSocialUser_notNull() {
        ...
        SocialUserDO socialUser = randomPojo(SocialUserDO.class,
                o -> o.setType(SocialTypeEnum.GITEE.getType()).setCode("tudou").setState("sample"));
        socialUserMapper.insert(socialUser);
        // 准备参数
        Integer socialType = SocialTypeEnum.GITEE.getType();
        Integer userType = randomEle(SocialTypeEnum.values()).getType();
    ...
    public void testGetSocialUserPage() {
        ...
        SocialUserDO dbSocialUser = randomPojo(SocialUserDO.class, o -> { // 等会查询到
            ...
            o.setNickname("Nimbus");
            o.setOpenid("nimbussample");
        ...
        reqVO.setNickname("Nim");
        reqVO.setOpenid("nimbus");
