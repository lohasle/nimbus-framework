package com.nimbus.module.system.service.permission;

import com.nimbus.framework.common.enums.CommonStatusEnum;
import com.nimbus.framework.test.core.ut.BaseDbUnitTest;
import com.nimbus.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.nimbus.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.nimbus.module.system.dal.dataobject.permission.MenuDO;
import com.nimbus.module.system.dal.mysql.permission.MenuMapper;
import com.nimbus.module.system.enums.permission.MenuTypeEnum;
...
import static com.nimbus.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("Nimbus").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        ...
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("Nim").setStatus(CommonStatusEnum.ENABLE.getStatus());
