package com.nimbus.module.system.service.sms;
...
import com.nimbus.module.system.controller.admin.sms.vo.template.SmsTemplatePageReqVO;
import com.nimbus.module.system.controller.admin.sms.vo.template.SmsTemplateSaveReqVO;
import com.nimbus.module.system.dal.dataobject.sms.SmsChannelDO;
import com.nimbus.module.system.dal.dataobject.sms.SmsTemplateDO;
import com.nimbus.module.system.dal.mysql.sms.SmsTemplateMapper;
import com.nimbus.module.system.enums.sms.SmsTemplateTypeEnum;
import com.nimbus.module.system.framework.sms.core.client.SmsClient;
import com.nimbus.module.system.framework.sms.core.client.dto.SmsTemplateRespDTO;
import com.nimbus.module.system.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
...
public class SmsTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetSmsTemplatePage() {
        ...
        // 测试 code 不匹配
        smsTemplateMapper.insert(ObjectUtils.cloneIgnoreId(dbSmsTemplate, o -> o.setCode("sample")));
        // 测试 content 不匹配
        smsTemplateMapper.insert(ObjectUtils.cloneIgnoreId(dbSmsTemplate, o -> o.setContent("Other")));
        ...
        reqVO.setCode("tu");
        reqVO.setContent("Nimbus");
        reqVO.setApiTemplateId("imb");
