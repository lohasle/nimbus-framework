package com.nimbus.module.system.service.logger;
...
import com.nimbus.module.system.controller.admin.logger.vo.loginlog.LoginLogPageReqVO;
import com.nimbus.module.system.dal.dataobject.logger.LoginLogDO;
import com.nimbus.module.system.dal.mysql.logger.LoginLogMapper;
...
import static com.nimbus.module.system.enums.logger.LoginResultEnum.CAPTCHA_CODE_ERROR;
import static com.nimbus.module.system.enums.logger.LoginResultEnum.SUCCESS;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        // 测试 username 不匹配
        loginLogMapper.insert(cloneIgnoreId(loginLogDO, o -> o.setUsername("nimbus")));
        // 测试 createTime 不匹配
