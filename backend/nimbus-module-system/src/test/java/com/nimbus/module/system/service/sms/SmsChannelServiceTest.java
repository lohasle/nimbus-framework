...
import com.nimbus.module.system.controller.admin.sms.vo.channel.SmsChannelSaveReqVO;
import com.nimbus.module.system.dal.dataobject.sms.SmsChannelDO;
import com.nimbus.module.system.dal.mysql.sms.SmsChannelMapper;
import com.nimbus.module.system.framework.sms.core.client.SmsClient;
import com.nimbus.module.system.framework.sms.core.client.SmsClientFactory;
import com.nimbus.module.system.framework.sms.core.property.SmsChannelProperties;
...
import static com.nimbus.module.system.enums.ErrorCodeConstants.SMS_CHANNEL_HAS_CHILDREN;
import static com.nimbus.module.system.enums.ErrorCodeConstants.SMS_CHANNEL_NOT_EXISTS;
...
public class SmsChannelServiceTest extends BaseDbUnitTest {
    ...
    public void testGetSmsChannelPage() {
       ...
       SmsChannelDO dbSmsChannel = randomPojo(SmsChannelDO.class, o -> { // 等会查询到
           o.setSignature("Nimbus");
           o.setStatus(CommonStatusEnum.ENABLE.getStatus());
           o.setCreateTime(buildTime(2020, 12, 12));
       });
       smsChannelMapper.insert(dbSmsChannel);
       // 测试 signature 不匹配
       smsChannelMapper.insert(cloneIgnoreId(dbSmsChannel, o -> o.setSignature("Other")));
       // 测试 status 不匹配
