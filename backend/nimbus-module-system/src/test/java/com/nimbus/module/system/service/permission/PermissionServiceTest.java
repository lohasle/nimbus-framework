...
import com.nimbus.framework.common.biz.system.permission.dto.DeptDataPermissionRespDTO;
...
import com.nimbus.module.system.dal.dataobject.permission.RoleMenuDO;
import com.nimbus.module.system.dal.dataobject.permission.UserRoleDO;
import com.nimbus.module.system.dal.dataobject.user.AdminUserDO;
import com.nimbus.module.system.dal.mysql.permission.RoleMenuMapper;
import com.nimbus.module.system.dal.mysql.permission.UserRoleMapper;
import com.nimbus.module.system.enums.permission.DataScopeEnum;
...
public class PermissionServiceTest extends BaseDbUnitTest {
    ...
    public void testHasAnyRoles() {
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            // 准备参数
            Long userId = 1L;
            String[] roles = new String[]{"nimbus", "tudou"};
            // mock 用户与角色的缓存
            userRoleMapper.insert(randomPojo(UserRoleDO.class).setUserId(userId).setRoleId(100L));
