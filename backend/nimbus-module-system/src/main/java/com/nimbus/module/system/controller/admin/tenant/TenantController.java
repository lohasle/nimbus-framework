package com.nimbus.module.system.controller.admin.tenant;
...
import com.nimbus.module.system.controller.admin.tenant.vo.tenant.TenantRespVO;
...
public class TenantController {
    ...
    @Parameter(name = "website", description = "域名", required = true, example = "www.nimbus.local")
