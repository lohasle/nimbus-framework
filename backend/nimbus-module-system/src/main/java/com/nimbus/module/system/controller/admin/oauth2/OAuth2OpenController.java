...
import com.nimbus.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.nimbus.module.system.util.oauth2.OAuth2Utils;
...
import static com.nimbus.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.nimbus.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
import static com.nimbus.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.nimbus.local"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.nimbus.local"),
