package com.nimbus.module.system.controller.admin.auth.vo;
...
public class AuthPermissionInfoRespVO {
    ...
    public static class UserVO {
        ...
        @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nimbus Framework")
        private String nickname;

        @Schema(description = "用户头像", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nimbus.local/xx.jpg")
    ...
    public static class MenuVO {
        ...
        @Schema(description = "菜单名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nimbus")
        private Long id;
