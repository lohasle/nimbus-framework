package com.nimbus.module.system.controller.admin.oauth2.vo.client;
...
public class OAuth2ClientSaveReqVO {
    ...
    @Schema(description = "应用图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nimbus.local/xx.png")
    ...
    @Schema(description = "可重定向的 URI 地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.nimbus.local")
    ...
    @Schema(description = "附加信息", example = "{nimbus: true}")
