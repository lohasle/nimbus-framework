package com.nimbus.module.system.controller.admin.user;
...
import com.nimbus.module.system.controller.admin.user.vo.user.*;
import com.nimbus.module.system.convert.user.UserConvert;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("nimbus").deptId(1L).email("nimbus@nimbus.local").mobile("15601691300")
                        .nickname("Nimbus").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("sample").deptId(2L).email("sample@nimbus.local").mobile("15601701300")
    ...
    @Parameter(name = "nickname", description = "昵称关键词", required = true, example = "Nimbus")
