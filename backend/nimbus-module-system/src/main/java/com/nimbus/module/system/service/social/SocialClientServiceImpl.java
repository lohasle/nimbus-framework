package com.nimbus.module.system.service.social;
...
import com.nimbus.framework.common.util.cache.CacheUtils;
import com.nimbus.framework.common.util.http.HttpUtils;
import com.nimbus.framework.common.util.object.BeanUtils;
import com.nimbus.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.nimbus.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.nimbus.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.nimbus.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.nimbus.module.system.dal.dataobject.social.SocialClientDO;
import com.nimbus.module.system.dal.mysql.social.SocialClientMapper;
import com.nimbus.module.system.dal.redis.RedisKeyConstants;
import com.nimbus.module.system.enums.social.SocialTypeEnum;
import com.nimbus.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.nimbus.framework.common.util.collection.MapUtils.findAndThen;
import static com.nimbus.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.nimbus.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${nimbus.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${nimbus.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/nimbus-cloud/pulls/230
