package com.nimbus.module.infra.service.logger;
...
import com.nimbus.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.nimbus.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.nimbus.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.nimbus.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.nimbus.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.nimbus.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("nimbus-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("nimbus-test");
    ...
    public void testCleanJobLog() {
        ...
        // TODO @Nimbus：createTime updateTime 被屏蔽，仅 win11 会复现，建议后续修复。
