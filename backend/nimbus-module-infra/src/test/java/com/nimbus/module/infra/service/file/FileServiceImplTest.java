...
import com.nimbus.framework.test.core.util.AssertUtils;
import com.nimbus.module.infra.controller.admin.file.vo.file.FileCreateReqVO;
import com.nimbus.module.infra.controller.admin.file.vo.file.FilePageReqVO;
import com.nimbus.module.infra.dal.dataobject.file.FileDO;
import com.nimbus.module.infra.dal.mysql.file.FileMapper;
...
import static com.nimbus.module.infra.enums.ErrorCodeConstants.FILE_NOT_EXISTS;
import static com.nimbus.module.infra.enums.ErrorCodeConstants.FILE_PATH_INVALID;
...
public class FileServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileByPresignedPath_success() {
        ...
        FileCreateReqVO reqVO = randomPojo(FileCreateReqVO.class, o -> {
            ...
            o.setName("test.jpg");
            o.setUrl("https://www.nimbus.local/test.jpg?token=123");
        });
        ...
        assertEquals("https://www.nimbus.local/test.jpg", file.getUrl());
    }
