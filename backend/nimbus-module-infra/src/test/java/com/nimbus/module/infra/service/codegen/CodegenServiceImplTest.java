package com.nimbus.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.nimbus.framework.common.pojo.PageResult;
import com.nimbus.framework.test.core.ut.BaseDbUnitTest;
import com.nimbus.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.nimbus.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.nimbus.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.nimbus.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.nimbus.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.nimbus.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.nimbus.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.nimbus.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.nimbus.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.nimbus.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.nimbus.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.nimbus.module.infra.enums.codegen.CodegenSceneEnum;
import com.nimbus.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.nimbus.module.infra.framework.codegen.config.CodegenProperties;
import com.nimbus.module.infra.service.codegen.inner.CodegenBuilder;
import com.nimbus.module.infra.service.codegen.inner.CodegenEngine;
import com.nimbus.module.infra.service.db.DataSourceConfigService;
import com.nimbus.module.infra.service.db.DatabaseTableService;
...
import static com.nimbus.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        CodegenCreateListReqVO reqVO = randomPojo(CodegenCreateListReqVO.class,
                o -> o.setDataSourceConfigId(1L).setTableNames(Collections.singletonList("t_nimbus")));
        // mock 方法（TableInfo）
        TableInfo tableInfo = mock(TableInfo.class);
        when(databaseTableService.getTable(eq(1L), eq("t_nimbus")))
                .thenReturn(tableInfo);
        when(tableInfo.getComment()).thenReturn("Nimbus");
    ...
    public void testSyncCodegenFromDB() {
        ...
        CodegenTableDO table = randomPojo(CodegenTableDO.class, o -> o.setTableName("t_nimbus")
    ...
    public void testGetCodegenTablePage() {
        ...
        CodegenTableDO tableDO = randomPojo(CodegenTableDO.class, o -> {
            o.setTableName("t_nimbus");
            o.setTableComment("Nimbus");
            o.setClassName("Systemnimbus");
        ...
        reqVO.setTableName("nimbus");
        reqVO.setTableComment("Nim");
        reqVO.setClassName("nimbus");
    ...
    public void testGetDatabaseTableList() {
        ...
        when(tableInfo01.getName()).thenReturn("t_nimbus");
        when(tableInfo01.getComment()).thenReturn("Nimbus");
        TableInfo tableInfo02 = mock(TableInfo.class);
        when(tableInfo02.getName()).thenReturn("t_nimbus_02");
        when(tableInfo02.getComment()).thenReturn("Nimbus_02");
        ...
        // 断言
        assertEquals(1, result.size());
        assertEquals("t_nimbus", result.get(0).getName());
        assertEquals("Nimbus", result.get(0).getComment());
    }
