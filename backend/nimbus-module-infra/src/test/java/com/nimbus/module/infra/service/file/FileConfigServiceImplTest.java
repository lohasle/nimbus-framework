package com.nimbus.module.infra.service.file;
...
import com.nimbus.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.nimbus.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.nimbus.module.infra.dal.dataobject.file.FileConfigDO;
import com.nimbus.module.infra.dal.mysql.file.FileConfigMapper;
import com.nimbus.module.infra.framework.file.core.client.FileClient;
import com.nimbus.module.infra.framework.file.core.client.FileClientConfig;
import com.nimbus.module.infra.framework.file.core.client.FileClientFactory;
import com.nimbus.module.infra.framework.file.core.client.local.LocalFileClient;
import com.nimbus.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.nimbus.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.nimbus.framework.test.core.util.RandomUtils.randomLongId;
import static com.nimbus.framework.test.core.util.RandomUtils.randomPojo;
import static com.nimbus.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.nimbus.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        // 准备参数
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/nimbus")
                .put("domain", "https://www.nimbus.local").build();
        ...
        assertEquals("/nimbus", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://www.nimbus.local", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/nimbus").setDomain("https://www.nimbus.local")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/nimbus2")
                    .put("domain", "https://doc.nimbus.local").build();
            o.setConfig(config);
        });
        ...
        assertEquals("/nimbus2", ((LocalFileClientConfig) fileConfig.getConfig()).getBasePath());
        assertEquals("https://doc.nimbus.local", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("Nimbus Framework")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.nimbus.local");

        // 调用，并断言
        assertEquals("https://www.nimbus.local", fileConfigService.testFileConfig(id));
    }
