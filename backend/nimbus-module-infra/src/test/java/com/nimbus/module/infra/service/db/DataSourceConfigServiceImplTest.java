package com.nimbus.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import com.nimbus.framework.mybatis.core.type.EncryptTypeHandler;
import com.nimbus.framework.mybatis.core.util.JdbcUtils;
import com.nimbus.framework.test.core.ut.BaseDbUnitTest;
import com.nimbus.module.infra.controller.admin.db.vo.DataSourceConfigSaveReqVO;
import com.nimbus.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.nimbus.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static com.nimbus.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        dataSourceProperty.setUsername("nimbus");
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("nimbus", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("nimbus", dataSourceConfigList.get(0).getUsername());
