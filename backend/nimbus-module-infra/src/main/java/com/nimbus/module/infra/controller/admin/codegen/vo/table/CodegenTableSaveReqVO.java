package com.nimbus.module.infra.controller.admin.codegen.vo.table;
...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "表名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "nimbus")
    @NotNull(message = "表名称不能为空")
    private String tableName;

    @Schema(description = "表描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nimbus")
    ...
    @Schema(description = "作者", requiredMode = Schema.RequiredMode.REQUIRED, example = "Nimbus Framework")
