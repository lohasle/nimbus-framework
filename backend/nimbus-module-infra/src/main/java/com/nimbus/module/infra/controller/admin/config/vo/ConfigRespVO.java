...
public class ConfigRespVO {
    ...
    @Schema(description = "参数键名", requiredMode = Schema.RequiredMode.REQUIRED, example = "nimbus.db.username")
    @ExcelProperty("参数键名")
    private String key;
