package com.nimbus.module.infra.controller.admin.codegen;
...
import com.nimbus.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.nimbus.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.nimbus.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.nimbus.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.nimbus.module.infra.convert.codegen.CodegenConvert;
...
import com.nimbus.module.infra.service.codegen.CodegenService;
...
import static com.nimbus.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.nimbus.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "nimbus"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "Nimbus")
    })
