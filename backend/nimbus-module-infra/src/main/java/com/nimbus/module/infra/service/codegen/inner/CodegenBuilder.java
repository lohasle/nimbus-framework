...
import com.nimbus.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import com.nimbus.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link com.nimbus.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getJavaField(), "name")) {
            column.setExample(randomEle(new String[]{"张三", "李四", "王五", "赵六", "Nimbus"}));
            return;
        }
        // status
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.nimbus.local");
            return;
        }
        // reason
