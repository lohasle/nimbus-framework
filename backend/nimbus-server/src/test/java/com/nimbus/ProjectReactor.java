...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.nimbus";
    private static final String ARTIFACT_ID = "nimbus";
    private static final String PACKAGE_NAME = "com.nimbus";
    private static final String TITLE = "Nimbus管理系统";
